...
static cl_int queue_hsr_kernel(struct __clState *clState, struct _dev_blk_ctx *blk, __maybe_unused cl_uint threads)
{
	cl_kernel *kernel;
	unsigned int num;
	cl_ulong le_target;
...
#undef A_DARK
  ...
  { "hsr", ALGO_HSR, "", 1, 1, 1, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 13, 8 * 16 * 4194304, 0, hsr_regenhash, NULL, queue_hsr_kernel, gen_hash, append_x13_compiler_options },
